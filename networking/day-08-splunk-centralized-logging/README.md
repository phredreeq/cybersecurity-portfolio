...
1. Splunk service running (Ubuntu) ![](day8_splunk_service_running.png)
2. Forwarder active connection (Windows) ![](day8_forwarder_connected.png)
3. Failed logons search results ![](day8_failed_logons_search.png)
4. Successful logons search results ![](day8_successful_logons_search.png)
5. Log statistics by host ![](day8_log_statistics_by_host.png)
6. SOC Monitoring dashboard view ![](day8_soc_monitoring_dashboard.png)
